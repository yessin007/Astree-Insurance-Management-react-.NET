...
namespace WebApplication1.Repository
{
    public class CompteBancaireRepository : ICompteBancaireRepository
    {
        ...
        public CompteBancaire ModifierCompteBancaireAstree(CompteBancaire compteBancaireAstree, string id)
        {
            ...
            astree.ReassureurId = compteBancaireAstree.ReassureurId;
        ...
        public CompteBancaire ModifierCompteBancaireReas(CompteBancaireReasDto compteBancaireReas, string id)
        {
            ...
            reas.ReassureurId = compteBancaireReas.ReassureurId;
        ...
        {
            return _context.CompteBancaires.Count();
