...
namespace WebApplication1.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpGet("Recherche")]
        public async Task<ActionResult<IEnumerable<GetUserWithRoles>>> Rechercher(string? termeRecherche)
        {
            ...
            var resultat = await _userManager.Users.Where(u => EF.Functions.Like(u.FirstName, $"%{termeRecherche}%" ) || EF.Functions.Like(u.LastName, $"%{termeRecherche}%")).ToListAsync();
            //var usersWithRoles = new List<GetUserWithRoles>();
