...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20230510151409_chatConnexion")]
    partial class chatConnexion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.CompteBancaire", b =>
                {
                    ...
                    b.Property<string>("ParametrageAstreeId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ParametrageAstreeId");
            ...
            modelBuilder.Entity("WebApplication1.Models.CompteBancaire", b =>
                {
                    b.HasOne("WebApplication1.Models.ParametrageAstree", "ParametrageAstree")
                        .WithMany("CompteBancaires")
                        .HasForeignKey("ParametrageAstreeId");

                    b.HasOne("WebApplication1.Models.Reassureur", "Reassureur")
                        .WithMany("CompteBancaires")
                        .HasForeignKey("ReassureurId");

                    b.Navigation("ParametrageAstree");
