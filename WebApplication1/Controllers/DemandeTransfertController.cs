...
namespace WebApplication1.Controllers
{
    ...
    public class DemandeTransfertController : ControllerBase
    {
        ...
        [HttpGet("LettreReass/{iduser}")]
        public IActionResult GetDemandeTransfertByUserId(string iduser)
        {

            var demande = _demandeTransfert.GetDemandeTransfertByUserId(iduser);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            return Ok(demande);
        }
        ...
        {
            var session = _demandeTransfert.GetConvs();
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            return Ok(session);
        }
        ...
        {
            var session = _demandeTransfert.GetFacs();
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            return Ok(session);
        }
        ...
        {
            return _demandeTransfert.getSommeFac();
        ...
        {
            return _demandeTransfert.getSommeConv();

        }
        [HttpGet("NombreDT")]
        public int nombreDT()
        {
            return _demandeTransfert.nombreDT();
