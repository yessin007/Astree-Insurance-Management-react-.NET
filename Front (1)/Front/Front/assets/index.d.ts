...
declare class Factory<TProps extends Record<string, unknown>> {
...
declare const InheritableImmutableRecord_base: Factory<T>;
...
interface InheritableImmutableRecord<T extends Record<string, unknown>> extends Factory<T> {
}
