import {
  ...
  import AddCompteModal from "./AddCompteBancaireReas";
  import EditModal from "./EditCompteReas";
  import DetailComponent from "./DetailComponentReas";
  import Card from "components/card/Card";
  import DeleteConfirmartion from './DeletConfirmation';
  ...
  export default function ColumnsTable(props) {
    ...
    useEffect(()=>{
      // recuperation des donner 
         function fetchData() {
            ...
            axios.get(url + "CompteBancaire/CompteBancaireReas").then(res=>{
            console.log("res : ");
    ...
    const handleAddItem = (itemNumeroCompte,itemRib,itemIban,itemBanque, itemAgence, itemAdresse,itemReasId) => {
      const newItem = {
        ...
        agence: itemAgence,
        adresse:itemAdresse,
        reassureurId:itemReasId.reassureurId,
        };
        console.log(newItem);
      axios.post(url + "CompteBancaire/CompteBancaireReas",newItem).then(res=>{
        console.log("res : ");
    ...
    const handleEditSubmit = (editedItem) => {
      ...
      axios.put(url + `CompteBancaire/CompteBancaireReas/${selectedItem.id}`,editedItem).then(res=>{
        console.log("res : ");
       }).catch(erreur=>{
        console.log(erreur);
      });
